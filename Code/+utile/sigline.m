...
plot(xs,[1;1]*y + 5,'-k', 'LineWidth',2);%line

%plot(mean(xs), y*1.15, '*k')% the sig star sign
%text(mean(xs), y*1.18, '***')% the sig star sign
...
plot([1;1]*xs(1),[y + 2.0,y + 5.1],'-k', 'LineWidth',2);%left edge drop
plot([1;1]*xs(2),[y + 2.0,y + 5.1],'-k', 'LineWidth',2);%right edge drop
